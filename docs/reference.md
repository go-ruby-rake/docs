...
The public API lives at the module root (`github.com/go-ruby-rake/rake`). It is
**Ruby-shaped but Go-idiomatic**: names mirror Ruby's `rake`, while the surface follows
...
```go
import "github.com/go-ruby-rake/rake"
```
...
- **[pkg.go.dev/github.com/go-ruby-rake/rake](https://pkg.go.dev/github.com/go-ruby-rake/rake)**

The module's [README](https://github.com/go-ruby-rake/rake#readme) carries worked
