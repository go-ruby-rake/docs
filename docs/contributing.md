...
Contributions are welcome. `go-ruby-rake/rake` is built to a small set of
...
The library is in [`github.com/go-ruby-rake/rake`](https://github.com/go-ruby-rake/rake).
This documentation site is in [`github.com/go-ruby-rake/docs`](https://github.com/go-ruby-rake/docs).
